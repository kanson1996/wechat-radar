...
def build_prompt(title: str, content: str, profile_text: str, max_content_length: int = 4000) -> list[dict]:
    """构建 AI 评分的 messages"""
...
def filter_article(title: str, content: str, config: dict) -> dict:
    ...
    messages = build_prompt(title, content, profile_text, max_content_length=max_content_length)
